    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4">
      <div className="bg-white p-8 rounded-3xl shadow-lg border max-w-md w-full">
        <div className="text-center mb-8">
          <div className="w-16 h-16 bg-brand-yellow text-brand-dark font-bold text-4xl flex items-center justify-center rounded-2xl mx-auto mb-4 tracking-tighter">
            M
          </div>
          <h2 className="text-2xl font-bold text-gray-900">Create Account</h2>
          <p className="text-gray-500 mt-1">Join McDonald's Portal</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full bg-brand-yellow hover:bg-yellow-500 text-brand-dark font-bold py-3.5 rounded-xl transition-colors disabled:opacity-70 mt-4 cursor-pointer shadow-sm"
          >
